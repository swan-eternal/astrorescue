...
# Find the highest level the player has unlocked (i.e., the most recent
# level they can play). Level 1 is always unlocked since SaveState starts
# with highest_level_completed = 0. We walk from MAX_LEVEL down to 1 and
# return the first unlocked one.
